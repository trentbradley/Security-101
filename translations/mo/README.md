...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:07:39+00:00",
...
在這個快速變化的人工智能技術時代，了解如何保護 IT 系統變得更加重要。本課程旨在教導您基本的網絡安全概念，幫助您開始學習安全知識。課程不依賴於特定供應商，分為小型課程，每節約需 30-60 分鐘完成。每節課包含小測驗及進一步閱讀的連結，讓您深入了解主題。

![Cybersecurity for Beginners](../../translated_images/banner.cc5b05d7e5deed065123ba68678b48cbbfe411cb264c09cec64f58eda064a28a.mo.jpg)

本課程涵蓋的內容 📚

- 🔐 基本網絡安全概念，例如 CIA 三元組、風險與威脅的區別等。
- 🛡️ 了解什麼是安全控制及其形式。
- 🌐 了解什麼是零信任及其在現代網絡安全中的重要性。
- 🔑 理解身份、網絡、安全運營、基礎設施及數據安全的關鍵概念和主題。
- 🔧 提供一些實施安全控制的工具範例。
...
| **1.3**           | 基本安全概念                   | [理解風險管理](https://github.com/microsoft/Security-101/blob/main/1.3%20Understanding%20risk%20management.md)       | 學習如何評估和理解風險——影響/可能性及實施控制措施。                                                                                                               | |
...
| **2.1**           | 身份與訪問管理基礎 | [IAM 關鍵概念](https://github.com/microsoft/Security-101/blob/main/2.1%20IAM%20key%20concepts.md)                     | 學習最小特權原則、職責分離及 IAM 如何支持零信任。               |
...
| **3.2**           | 網絡安全基礎             | [網絡零信任架構](https://github.com/microsoft/Security-101/blob/main/3.2%20Networking%20zero%20trust%20architecture.md)   | 學習網絡如何貢獻於端到端零信任架構及其減輕的威脅。                  |
...
| **4.1**           | 安全運營基礎          | [SecOps 關鍵概念](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | 學習為什麼安全運營很重要及其與普通 IT 運營團隊的區別。                  |
...
| **5.1**           | 應用程式安全基礎知識                     | [應用程式安全關鍵概念](https://github.com/microsoft/Security-101/blob/main/5.1%20AppSec%20key%20concepts.md)                  | 學習應用程式安全的概念，例如設計安全、輸入驗證等。                                    |
| **5.2**           | 應用程式安全基礎知識                     | [應用程式安全功能](https://github.com/microsoft/Security-101/blob/main/5.2%20AppSec%20key%20capabilities.md)                  | 學習應用程式安全工具：管道安全工具、程式碼掃描、密碼掃描等。                       |
| **5.3**           | [模組結束測驗](https://github.com/microsoft/Security-101/blob/main/5.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |
| **6.1**           | 基礎設施安全基礎知識                   | [基礎設施安全關鍵概念](https://github.com/microsoft/Security-101/blob/main/6.1%20Infrastructure%20security%20key%20concepts.md) | 學習如何強化系統、修補漏洞、安全衛生、容器安全等。                                  |
...
| **8.1**           | 人工智能安全基礎知識                   | [人工智能安全關鍵概念](https://github.com/microsoft/Security-101/blob/main/8.1%20AI%20security%20key%20concepts.md)          | 學習傳統安全與人工智能安全之間的異同點。                 |
| **8.2**           | 人工智能安全基礎知識                   | [人工智能安全功能](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | 學習人工智能安全工具及可用於保護人工智能的控制措施。                         |
| **8.3**           | 人工智能安全基礎知識                   | [負責任的人工智能](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | 學習什麼是負責任的人工智能以及安全專業人員需要注意的人工智能特定風險。                          |
...
如果您在構建人工智能應用程式時遇到困難或有任何問題，歡迎加入學習者和經驗豐富的開發者的討論社區。這是一個支持性的社群，歡迎提問並自由分享知識。
