...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:03:02+00:00",
...
[![تماشاگران GitHub](https://img.shields.io/github/watchers/microsoft/Security-101)](https://github.com/microsoft/Security-101/watchers)  
[![فورک‌های GitHub](https://img.shields.io/github/forks/microsoft/Security-101)](https://github.com/microsoft/Security-101/forks)  
...
> 💁 اگر بازخورد یا پیشنهادی در مورد این دوره و محتوایی که ممکن است از دست داده باشیم دارید، خوشحال می‌شویم از شما بشنویم!
...
| **2.1**           | اصول مدیریت هویت و دسترسی | [مفاهیم کلیدی IAM](https://github.com/microsoft/Security-101/blob/main/2.1%20IAM%20key%20concepts.md)                     | یادگیری درباره اصل حداقل امتیاز، جداسازی وظایف، و چگونگی پشتیبانی IAM از اعتماد صفر.               |
...
| **4.1**           | اصول عملیات امنیتی          | [مفاهیم کلیدی SecOps](https://github.com/microsoft/Security-101/blob/main/4.1%20SecOps%20key%20concepts.md)                  | یادگیری درباره اینکه چرا عملیات امنیتی مهم است و چگونه با تیم‌های معمولی IT متفاوت است.                  |
...
| **۵.۱**           | اصول امنیت برنامه‌ها                     | [مفاهیم کلیدی امنیت برنامه‌ها](https://github.com/microsoft/Security-101/blob/main/5.1%20AppSec%20key%20concepts.md)                  | درباره مفاهیمی مانند طراحی امن، اعتبارسنجی ورودی و موارد دیگر بیاموزید.                                    |
| **۵.۲**           | اصول امنیت برنامه‌ها                     | [قابلیت‌های امنیت برنامه‌ها](https://github.com/microsoft/Security-101/blob/main/5.2%20AppSec%20key%20capabilities.md)                  | درباره ابزارهای امنیت برنامه‌ها مانند ابزارهای امنیتی خط لوله، اسکن کد، اسکن اسرار و غیره بیاموزید.                       |
| **۵.۳**           | [آزمون پایان ماژول](https://github.com/microsoft/Security-101/blob/main/5.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |
| **۶.۱**           | اصول امنیت زیرساخت‌ها                   | [مفاهیم کلیدی امنیت زیرساخت‌ها](https://github.com/microsoft/Security-101/blob/main/6.1%20Infrastructure%20security%20key%20concepts.md) | درباره تقویت سیستم‌ها، به‌روزرسانی، بهداشت امنیتی و امنیت کانتینرها بیاموزید.                                  |
| **۶.۲**           | اصول امنیت زیرساخت‌ها                   | [قابلیت‌های امنیت زیرساخت‌ها](https://github.com/microsoft/Security-101/blob/main/6.2%20Infrastructure%20security%20capabilities.md) | درباره ابزارهایی که می‌توانند در امنیت زیرساخت‌ها کمک کنند مانند CSPM، امنیت کانتینرها و غیره بیاموزید.            |
| **۶.۳**           | [آزمون پایان ماژول](https://github.com/microsoft/Security-101/blob/main/6.3%20End%20of%20module%20quiz.md)                        |                                      |                                                                                                                 |
| **۷.۱**           | اصول امنیت داده‌ها                      | [مفاهیم کلیدی امنیت داده‌ها](https://github.com/microsoft/Security-101/blob/main/7.1%20Data%20security%20key%20concepts.md)           | درباره طبقه‌بندی و نگهداری داده‌ها و اهمیت آن برای سازمان‌ها بیاموزید.                     |
| **۷.۲**           | اصول امنیت داده‌ها                      | [قابلیت‌های امنیت داده‌ها](https://github.com/microsoft/Security-101/blob/main/7.2%20Data%20security%20capabilities.md)           | درباره ابزارهای امنیت داده‌ها مانند DLP، مدیریت ریسک داخلی، حاکمیت داده‌ها و غیره بیاموزید.                          |
| **۷.۳**           | [آزمون پایان ماژول](https://github.com/microsoft/Security-101/blob/main/7.3%20End%20of%20module%20quiz.md)                        |
| **۸.۱**           | اصول امنیت هوش مصنوعی                  | [مفاهیم کلیدی امنیت هوش مصنوعی](https://github.com/microsoft/Security-101/blob/main/8.1%20AI%20security%20key%20concepts.md)          | درباره تفاوت‌ها و شباهت‌های امنیت سنتی و امنیت هوش مصنوعی بیاموزید.                 |
| **۸.۲**           | اصول امنیت هوش مصنوعی                  | [قابلیت‌های امنیت هوش مصنوعی](https://github.com/microsoft/Security-101/blob/main/8.2%20AI%20security%20capabilities.md)           | درباره ابزارهای امنیت هوش مصنوعی و کنترل‌هایی که می‌توانند برای ایمن‌سازی هوش مصنوعی استفاده شوند بیاموزید.                         |
| **۸.۳**           | اصول امنیت هوش مصنوعی                  | [هوش مصنوعی مسئولانه](https://github.com/microsoft/Security-101/blob/main/8.3%20Responsible%20AI.md)          | درباره مفهوم هوش مصنوعی مسئولانه و آسیب‌های خاص هوش مصنوعی که متخصصان امنیت باید از آن‌ها آگاه باشند بیاموزید.                          |
...
اگر در ساخت برنامه‌های هوش مصنوعی گیر کردید یا سوالی دارید، به جامعه‌ای از یادگیرندگان و توسعه‌دهندگان باتجربه بپیوندید. این یک جامعه حمایتی است که در آن سوالات پذیرفته می‌شوند و دانش آزادانه به اشتراک گذاشته می‌شود.
